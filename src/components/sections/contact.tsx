...
export function Contact() {
  return (
    <section id="contact" className="container mx-auto py-24">
      <div className="section-shell p-6 md:p-8 lg:p-12 text-center relative overflow-hidden">
        <div className="absolute inset-0 grid-overlay opacity-40 pointer-events-none" />
        <motion.div
          className="font-headline text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-gradient leading-tight"
      ...
      <div className="mt-8 md:mt-10 section-shell p-5 md:p-8 text-center">
