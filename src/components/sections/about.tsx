      ...
      <div className="grid md:grid-cols-3 gap-12 items-start">
        <div className="flex justify-center md:col-span-1">
          <PixelCard variant="pink" className="rounded-full">
            <Image src="https://i.ibb.co/wrMzQqgD/IMG-20251229-190558-670-2.jpg" alt="Sarthak" fill priority className="absolute inset-0 w-full h-full object-cover rounded-full" />
          </PixelCard>
        </div>
