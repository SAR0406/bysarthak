...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`h-[300px] w-[300px] md:h-[400px] md:w-[400px] relative overflow-hidden grid place-items-center aspect-square border border-zinc-800 rounded-full isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
